// Headless end-to-end smoke for the "bring your own task" demo: a task authored
// from scratch (money_choice) paired with the packaged hyperbolic model, driven
// through the real Web Worker + WASM. Confirms an authored task registers and runs
// end-to-end. mock = generic wiring; stan = the WASM path.
//
// Run:  node tests/browser/byo_task_money_choice_smoke.mjs   (needs puppeteer)
...
const PAGE = "/demos/byo_task_money_choice/index.html";
